    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#">Cifrado RSA</a>
                </li>
                <li class="nav-item">
                            ...
                            foreach($query_run as $tarjeta){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-warning"  href="ver_rsa_des.php?id=<?= $tarjeta['id']; ?>"><i class="material-icons">remove_red_eye</i></a>                                
